...
<tr class="field_option field_option_<?php echo $this->name; ?>">
	...
	*-------------------------------------------------------------------------------------*/
	...
	function admin_print_scripts()
	{
		...
		wp_register_script( 'acf-input-leaflet_field', $this->settings['dir'] . 'js/input.js', array('acf-input'), $this->settings['version'] );
		
		// scripts
		wp_enqueue_script(array(
			'acf-input-leaflet_field',	
		));
	...
	function admin_print_styles()
	{
		...
		wp_register_style( 'acf-input-leaflet_field', $this->settings['dir'] . 'css/input.css', array('acf-input'), $this->settings['version'] ); 
